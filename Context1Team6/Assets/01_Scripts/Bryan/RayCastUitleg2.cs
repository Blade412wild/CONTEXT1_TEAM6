...
{
    public class RayCastUitleg2 : MonoBehaviour
    {
        ...
        private void ChangeCube()
        {
            if (gameObject.CompareTag("Artist"))
            {
                ...
                {
                    if (hit.transform.gameObject.GetComponent<ObstacleDoor>())
                    {
                    ...
                    if (hit.transform.gameObject.GetComponent<TruePathDoor>())
                    {
                        Destroy(hit.transform.gameObject);
                ...
                {
                    if (hit1.transform.gameObject.GetComponent<ObstacleDoor>())
                    {
                    ...
                    if (hit1.transform.gameObject.GetComponent<TruePathDoor>())
                    {
                        Destroy(hit1.transform.gameObject);
                ...
                {
                    if (hit2.transform.gameObject.GetComponent<ObstacleDoor>())
                    {
                    ...
                    if (hit2.transform.gameObject.GetComponent<TruePathDoor>())
                    {
                        Destroy(hit2.transform.gameObject);
